...
def main():
    ...
    parser.add_argument(
        "--embedding-size", default=300, type=int, required=False)
    parser.add_argument(
        "--num-positions", default=25, type=int, required=False)

    parser.add_argument(
        "--save-module", default=None, required=False, type=str)
    parser.add_argument(
    ...
    module = spensum.module.Position(args.num_positions, mode="pretrain")
