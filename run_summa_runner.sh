python python_main/train_summarunner.py \
    ...
    --gpu 0 \
    --results-path /home/kedzie/spensum/results/nyt.sds.summa.runner.json \
...
python python_main/train_summarunner.py \
    ...
    --gpu 0 \
    --results-path /home/kedzie/spensum/results/duc.sds.summa.runner.json \
    --model-path /home/kedzie/spensum/models/duc.sds.summa.runner.bin \
    --epochs 50 \
    --context-dropout .7 \
    #--context-size 200 \
    #--epochs 100
